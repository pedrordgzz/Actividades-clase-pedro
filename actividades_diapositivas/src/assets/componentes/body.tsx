...
export const GaleriaCarrusel = () => {
  // Al estar las imágenes en la carpeta "public", la ruta empieza con "/"
  const andaluciaImages = [
    ...
    {
      id: 8,
      src: '/jaen.jpg', // Añadida porque aparece en tu carpeta public
      alt: 'Catedral de Jaén',
      captionTitle: 'Jaén',
      captionText: 'La imponente Catedral de la Asunción.',
    },
  ];
...
export const Body = () => {
  return (
    <>
      <h2 className="h2-titulo">Sección de Cards (Inicio)</h2>
